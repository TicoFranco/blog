...
import { loginUser } from '@/app/services/Users/loginUser';
...
export default function Login() {
  ...
  return (
    <div className='bg-blue-950 min-h-screen'>
        ...
        {state ? <ResultModal result={result} setResult={setResult} state={state} setState={setState} sucessText='Login successfully' failureText={failureText} />: null}
    </div>
  )
}
